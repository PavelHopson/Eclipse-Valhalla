...
export const translations = {
  en: {
    ...
    'workout.rec_ritual': 'Morning Ritual ⚡',
    'workout.rec_ritual_desc': '5 exercises × 2 rounds × 30s each. 5 minutes. Every day. No excuses.',
    'workout.rec_plank_daily': 'Daily Plank 🧱',
    'workout.rec_plank_daily_desc': '2 minutes. Strengthens core, posture, stability. Mental endurance.',
    'workout.rec_wallsit_daily': 'Daily Wall Sit 🪑',
    'workout.rec_wallsit_daily_desc': 'Back against wall. Not about time — about control and discipline.',
    'workout.desc_pushups': 'Full range of motion. Chest to floor, arms fully extended. If too hard — do from wall or incline.',
    'workout.desc_squats': 'Feet shoulder-width. Go deep — thighs parallel to floor. Back straight, core tight.',
    'workout.desc_bird_dog': 'On all fours. Extend opposite arm + leg. Hold 2 seconds. Switch sides.',
    'workout.desc_static': 'Lie face down, arms forward. Lift arms + legs off floor. Hold position, squeeze glutes.',
    'workout.desc_plank': 'Forearms on floor, body straight line. Squeeze abs + glutes. Don\'t drop hips.',
    'workout.desc_plank_long': 'Hold plank for 2 full minutes. Core of steel. If you shake — you\'re growing.',
    'workout.desc_wallsit': 'Back flat against wall, thighs parallel to floor. Knees at 90°. It\'s not about time — it\'s about control and discipline.',
    'workout.ex_plank_2min': 'Plank (2 min hold)',
    'workout.ex_wall_sit_hold': 'Wall Sit (hold)',
    'workout.ex_squats_power': 'Squats (power)',
    'workout.ex_squats_slow': 'Squats (slow tempo: 2s down, 1s up)',
    'workout.ex_calf_raises': 'Standing Calf Raises',
    'workout.rec_street_compound': 'Street Compound 🏗️',
    'workout.rec_street_compound_desc': 'Pull-ups, dips, rows, split squats. Full body with balance. Needs a bar + something heavy.',
    'workout.ex_pullups': 'Pull-ups',
    'workout.ex_horizontal_row': 'Horizontal Row (inverted)',
    'workout.ex_dip_bars': 'Dips (parallel bars)',
    'workout.ex_decline_pushups': 'Decline Push-ups',
    'workout.ex_bulgarian_split': 'Bulgarian Split Squat',
    'workout.ex_single_leg_rdl': 'Single-Leg RDL (water jug / dumbbell / backpack)',
    'workout.rec_legs_power': 'Leg Power 🦵',
    'workout.rec_legs_power_desc': 'Strong legs = athleticism, stability, real fitness. Weak legs = unfinished look.',
    ...
    'workout.ex_bird_dog': 'Bird Dog',
    'workout.ex_static_hold': 'Static Hold',
    ...
    'achievements.ritual_start': 'Dawn Warrior',
    'achievements.ritual_start_desc': 'Complete your first Morning Ritual.',
    'achievements.ritual_week': 'Week of Iron',
    'achievements.ritual_week_desc': '7 Morning Rituals completed.',
    'achievements.ritual_month': 'Forged in 30 Days',
    'achievements.ritual_month_desc': '30 Morning Rituals. Unbreakable.',
    'achievements.ritual_legend': 'Living Legend',
    'achievements.ritual_legend_desc': '100 Morning Rituals. You are the system.',
    'achievements.plank_start': 'First Plank',
    'achievements.plank_start_desc': 'Hold your first 2-minute plank.',
    'achievements.plank_week': 'Iron Core Week',
    'achievements.plank_week_desc': '7 days of daily planks.',
    'achievements.plank_month': 'Unbreakable Core',
    'achievements.plank_month_desc': '30 days of daily planks. Core of steel.',
    'achievements.wallsit_start': 'First Wall Sit',
    'achievements.wallsit_start_desc': 'Hold your first wall sit.',
    'achievements.wallsit_week': 'Legs of Stone',
    'achievements.wallsit_week_desc': '7 days of daily wall sits.',
    'achievements.wallsit_month': 'Immovable Foundation',
    'achievements.wallsit_month_desc': '30 days of wall sits. Discipline is built by endurance.',
    'achievements.street_start': 'Street Rookie',
    'achievements.street_start_desc': 'Complete your first Street Compound workout.',
    'achievements.street_week': 'Bar Veteran',
    'achievements.street_week_desc': '7 Street Compound workouts.',
    'achievements.street_month': 'Compound Machine',
    'achievements.street_month_desc': '30 Street Compound workouts. Full body mastery.',
    ...
    'careers.cvTailor.title': 'CV Tailor',
    'careers.cvTailor.open': 'Tailor CV',
    'careers.cvTailor.baseCV': 'Your base CV',
    'careers.cvTailor.baseCVPlaceholder': 'Paste your generic CV here…',
    'careers.cvTailor.jobTitle': 'Position',
    'careers.cvTailor.jobCompany': 'Company',
    'careers.cvTailor.jobDescription': 'Job description',
    'careers.cvTailor.jobDescriptionPlaceholder': 'Paste the job description…',
    'careers.cvTailor.emphasize': 'Skills to emphasize',
    'careers.cvTailor.emphasizePlaceholder': 'Optional — e.g. TypeScript, system design…',
    'careers.cvTailor.generate': 'Generate',
    'careers.cvTailor.regenerate': 'Regenerate',
    'careers.cvTailor.analyzing': 'Analyzing your CV…',
    'careers.cvTailor.matchScore': 'Match score',
    'careers.cvTailor.keyChanges': 'Key changes',
    'careers.cvTailor.tailoredCV': 'Tailored CV',
    'careers.cvTailor.copy': 'Copy',
    'careers.cvTailor.copied': 'Copied',
    'careers.cvTailor.save': 'Save to application',
    'careers.cvTailor.saved': 'Saved to application',
    'careers.cvTailor.error': 'Failed to tailor CV.',
    'careers.cvTailor.noProvider': 'No AI provider configured. Go to Settings → AI Providers.',
  },
  ru: {
    'app.title': 'ECLIPSE VALHALLA',
    ...
    'workout.rec_ritual': 'Утренний ритуал ⚡',
    'workout.rec_ritual_desc': '5 упражнений × 2 круга × 30с. 5 минут. Каждый день. Без оправданий.',
    'workout.rec_plank_daily': 'Ежедневная планка 🧱',
    'workout.rec_plank_daily_desc': '2 минуты. Укрепление корпуса, осанки, стабильности. Ментальная закалка.',
    'workout.rec_wallsit_daily': 'Ежедневный стульчик 🪑',
    'workout.rec_wallsit_daily_desc': 'Спиной к стене. Не про время — про контроль, дисциплину и выдержку.',
    'workout.desc_pushups': 'Полная амплитуда. Грудь к полу, руки полностью выпрямлены. Если тяжело — делай от стены или с опоры.',
    'workout.desc_squats': 'Ноги на ширине плеч. Опускайся глубоко — бёдра параллельно полу. Спина прямая, пресс напряжён.',
    'workout.desc_bird_dog': 'На четвереньках. Вытяни противоположную руку + ногу. Удерживай 2 секунды. Смени сторону.',
    'workout.desc_static': 'Лёжа лицом вниз, руки вперёд. Подними руки + ноги от пола. Удерживай, сжимай ягодицы.',
    'workout.desc_plank': 'Предплечья на полу, тело — прямая линия. Напряги пресс + ягодицы. Не проваливай таз.',
    'workout.desc_plank_long': 'Удерживай планку 2 полные минуты. Стальной корпус. Если трясёшься — ты растёшь.',
    'workout.desc_wallsit': 'Спина прижата к стене, бёдра параллельно полу. Колени 90°. Не про время — про контроль и дисциплину.',
    'workout.ex_plank_2min': 'Планка (2 мин удержание)',
    'workout.ex_wall_sit_hold': 'Стульчик у стены (удержание)',
    'workout.ex_squats_power': 'Приседания (силовые)',
    'workout.ex_squats_slow': 'Приседания (медленный темп: 2с вниз, 1с вверх)',
    'workout.ex_calf_raises': 'Подъёмы на носки стоя',
    'workout.rec_street_compound': 'Уличная база 🏗️',
    'workout.rec_street_compound_desc': 'Подтягивания, брусья, тяги, сплит-присед. Всё тело + баланс. Нужен турник + что-то тяжёлое.',
    'workout.ex_pullups': 'Подтягивания',
    'workout.ex_horizontal_row': 'Горизонтальная тяга',
    'workout.ex_dip_bars': 'Отжимания на брусьях',
    'workout.ex_decline_pushups': 'Отжимания в наклоне',
    'workout.ex_bulgarian_split': 'Болгарский сплит-присед',
    'workout.ex_single_leg_rdl': 'Румынская тяга на одной ноге (канистра/гантель/рюкзак)',
    'workout.rec_legs_power': 'Сила ног 🦵',
    'workout.rec_legs_power_desc': 'Сильные ноги — основа атлетичности, стабильности и настоящей формы. Слабый низ = несобранный вид.',
    ...
    'workout.ex_bird_dog': 'Bird Dog (на четвереньках)',
    'workout.ex_static_hold': 'Статика (удержание)',
    ...
    'achievements.ritual_start': 'Воин рассвета',
    'achievements.ritual_start_desc': 'Заверши первый Утренний ритуал.',
    'achievements.ritual_week': 'Неделя из стали',
    'achievements.ritual_week_desc': '7 Утренних ритуалов завершено.',
    'achievements.ritual_month': 'Закалён за 30 дней',
    'achievements.ritual_month_desc': '30 Утренних ритуалов. Несокрушим.',
    'achievements.ritual_legend': 'Живая легенда',
    'achievements.ritual_legend_desc': '100 Утренних ритуалов. Ты — система.',
    'achievements.plank_start': 'Первая планка',
    'achievements.plank_start_desc': 'Удержи первую 2-минутную планку.',
    'achievements.plank_week': 'Стальной корпус',
    'achievements.plank_week_desc': '7 дней ежедневных планок.',
    'achievements.plank_month': 'Несокрушимый корпус',
    'achievements.plank_month_desc': '30 дней планок. Укрепление корпуса, осанка, стабильность. Ментальная закалка.',
    'achievements.wallsit_start': 'Первый стульчик',
    'achievements.wallsit_start_desc': 'Удержи первый стульчик у стены.',
    'achievements.wallsit_week': 'Каменные ноги',
    'achievements.wallsit_week_desc': '7 дней ежедневных стульчиков.',
    'achievements.wallsit_month': 'Несдвигаемый фундамент',
    'achievements.wallsit_month_desc': '30 дней стульчиков. Сильные ноги строятся выдержкой, не движением.',
    'achievements.street_start': 'Уличный новичок',
    'achievements.street_start_desc': 'Заверши первую уличную тренировку.',
    'achievements.street_week': 'Ветеран турника',
    'achievements.street_week_desc': '7 уличных тренировок.',
    'achievements.street_month': 'Машина базы',
    'achievements.street_month_desc': '30 уличных тренировок. Полное владение телом.',
    ...
    'careers.cvTailor.title': 'Настройка CV',
    'careers.cvTailor.open': 'Настроить CV',
    'careers.cvTailor.baseCV': 'Ваше CV',
    'careers.cvTailor.baseCVPlaceholder': 'Вставьте сюда своё обычное CV…',
    'careers.cvTailor.jobTitle': 'Должность',
    'careers.cvTailor.jobCompany': 'Компания',
    'careers.cvTailor.jobDescription': 'Описание вакансии',
    'careers.cvTailor.jobDescriptionPlaceholder': 'Вставьте описание вакансии…',
    'careers.cvTailor.emphasize': 'Что подчеркнуть',
    'careers.cvTailor.emphasizePlaceholder': 'Необязательно — напр. TypeScript, system design…',
    'careers.cvTailor.generate': 'Сгенерировать',
    'careers.cvTailor.regenerate': 'Перегенерировать',
    'careers.cvTailor.analyzing': 'Анализ вашего CV…',
    'careers.cvTailor.matchScore': 'Соответствие',
    'careers.cvTailor.keyChanges': 'Ключевые изменения',
    'careers.cvTailor.tailoredCV': 'Адаптированное CV',
    'careers.cvTailor.copy': 'Скопировать',
    'careers.cvTailor.copied': 'Скопировано',
    'careers.cvTailor.save': 'Сохранить в отклик',
    'careers.cvTailor.saved': 'Сохранено в отклик',
    'careers.cvTailor.error': 'Не удалось адаптировать CV.',
    'careers.cvTailor.noProvider': 'AI-провайдер не настроен. Зайдите в Настройки → AI-провайдеры.',
  }
};
